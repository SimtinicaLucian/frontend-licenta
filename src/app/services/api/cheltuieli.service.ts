 ...
 * @param reportProgress flag to report request and response progress.
 */
        public getData(beneficiar: string, data1?: string, data2?: string, sumaTotala1?: number, sumaTotala2?: number, stare?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Cheltuieli>>;
        public getData(beneficiar: string, data1?: string, data2?: string, sumaTotala1?: number, sumaTotala2?: number, stare?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Cheltuieli>>>;
        public getData(beneficiar: string, data1?: string, data2?: string, sumaTotala1?: number, sumaTotala2?: number, stare?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpResponse<Array<Cheltuieli>>>;
        public getData(beneficiar: string, data1?: string, data2?: string, sumaTotala1?: number, sumaTotala2?: number, stare?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
      public getDatesAfterMonthAndYear(month: string, year?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Cheltuieli>>;
      public getDatesAfterMonthAndYear(month: string, year?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Cheltuieli>>>;
      public getDatesAfterMonthAndYear(month: string, year?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpResponse<Array<Cheltuieli>>>;
      public getDatesAfterMonthAndYear(month: string, year?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
          ...
          return this.httpClient.get<Array<Cheltuieli>>(`${this.basePath}/cheltuieli/search/monthandyear`,
              {
                  params: queryParameters,
                  withCredentials: this.configuration.withCredentials,
                  headers: headers,
